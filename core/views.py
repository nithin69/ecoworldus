...
class PaymentView(View):
    ...
    def post(self, *args, **kwargs):
        ...
        if form.is_valid():
            ...
            amount = int(order.get_total() * 100) + (int(7.99) * 100)
            print("amount", amount, order.get_total())
